...
// m5stack_tab5.c, st7123_vendor_specific_init_default[]). This production copy
// uses 0x36<-0x00 (the driver's built-in default uses 0x03); use this one.
// The tail sends SLPOUT (0x11, +100ms) / DISPON (0x29) / TEON (0x35, +100ms).

#include "tab5_st7123_init.h"

const st7123_lcd_init_cmd_t tab5_st7123_init[] = {
    ...
    {0x11, (uint8_t[]){0x00}, 1, 100},    // SLPOUT + 100ms
    {0x29, (uint8_t[]){0x00}, 1, 0},      // DISPON
    {0x35, (uint8_t[]){0x00}, 1, 100},    // TEON + 100ms
};

const size_t tab5_st7123_init_len =
    sizeof(tab5_st7123_init) / sizeof(tab5_st7123_init[0]);
