...
// a generic ILI9881C init will not correctly light this exact panel.
// Format: {cmd, {data...}, data_size, delay_ms}, paged via 0xFF {0x98,0x81,page}.

#include "tab5_ili9881c_init.h"


const ili9881c_lcd_init_cmd_t tab5_ili9881c_init[] = {
...
const size_t tab5_ili9881c_init_len =
    sizeof(tab5_ili9881c_init) / sizeof(tab5_ili9881c_init[0]);
